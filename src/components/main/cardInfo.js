...
export const Individual = {
  img:
    'https://res.cloudinary.com/dnsdvh13n/image/upload/c_scale,f_auto,w_1018/v1549322970/GolfWithPeter/F78C4A8B-BE0C-4A20-BB0E-5A9BC46477C9.jpg',
  price: '$55',
  type: 'Adult',
  desc:
...
export const Junior = {
  img:
    'https://res.cloudinary.com/dnsdvh13n/image/upload/v1549961135/GolfWithPeter/3294.jpg',
  price: '$45',
  type: 'Junior',
  desc:
...
export const Group = {
  img:
    'https://res.cloudinary.com/dnsdvh13n/image/upload/c_scale,f_auto,q_auto,w_1000/v1548745026/GolfWithPeter/activity-background-bags-424766.jpg',
  price: '$120',
  type: 'Group',
  desc:
...
export const BagMapping = {
  img:
    'https://res.cloudinary.com/dnsdvh13n/image/upload/f_auto/v1558468279/GolfWithPeter/bag-mapping.jpg',
  price: '$95',
  type: 'Bag Mapping',
  desc:
